...
<?php if ( $design_query->have_posts() ) : ?>
    <?php while ( $design_query->have_posts() ) : $design_query->the_post(); ?>
      ...
      <!-- ============================
            SIMPLE FIELD: Land Space
            ============================ -->
      <p><strong>Land Space:</strong> 
          <?php echo carbon_get_post_meta(get_the_ID(), 'design_sizes'); ?>
      </p>


      <!-- ============================
            SIMPLE IMAGE FIELD: Floor Plan
            ============================ -->
      <?php 
      ...
      <!-- ============================
            COMPLEX FIELD: Floor Plan Details
            design_floor_plan_details[]
            fields: design_space, design_sqm
            ============================ -->
          ...
          ?>
              <div class="detail-item">
                  <p><strong>Space:</strong> 
                      <?php echo esc_html($detail['design_space']); ?>
                  </p>

                  <p><strong>SQM:</strong> 
                      <?php echo esc_html($detail['design_sqm']); ?>
                  </p>
              </div>
          <?php endforeach; else : ?>
      ...
      <!-- ============================
            COMPLEX FIELD: Slider Images
            design_slider[]
            fields: design_images (url)
            ============================ -->
    ...
    <div class="house-right">
      ...
      <ul id="spec-list" class="layout-list" role="list">
          <li class="layout-item">
            <span class="layout-label">Lounge</span>
            <span class="layout-value">12Sqm</span>
          </li>
      </ul>

      <div class="layout-total">
        <span id="total-label" class="total-label">Total Price</span>
        <span id="total-value" class="total-value">usd$ 400,000</span>
      </div>
    </div>
      ...
      <div class="floor-frames">
        ...
        <div id="panel-drawing" class="floor-panel" role="tabpanel">
          <div class="floor-image-plan">
            <img id="plan-drawing" class="floor-image-1" src="#"
                 alt="Floor Plan" />
          </div>
        </div>
    ...
    <div id="houseImageCarousel" class="carousel slide house-image" data-bs-ride="carousel">
      <div class="carousel-inner">
          <div class="carousel-item">
            <img src="#" class="d-block w-100" alt="SLIDER IMAGES">
          </div>
      </div>
